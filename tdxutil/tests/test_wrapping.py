...
def test_wraps():
    ...
    assert_equal(f_lost_args(0, 0), 'wrapped')
    assert_equal(f_kept_args_one_level(0, 0), 'wrapped')
    assert_equal(f_kept_args_two_levels(0, 0), 'wrapped')
